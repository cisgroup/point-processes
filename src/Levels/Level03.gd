...
func setup_ui() -> void:
	UI.get_node("Background/TitleOverlay").text = "Level 3: Poisson"
	UI.get_node("Lambda").visible = true
	...
	UI.get_node("OverlayMenu/GridButton").visible = true
	UI.get_node("OverlayMenu/GraphButton").visible = true
	UI.get_node("OverlayMenu/ModelButton").visible = true
# Point Processes
# =============================================================================
...
func run()->void:
	...
	var num_of_trees = random_poisson(lambda*C)
