...
func setup_ui() -> void:
	UI.get_node("Background/TitleOverlay").text = "Level 6: Regular"
	...
	UI.get_node("SliderMenu/Lambda2Slider").visible = false
	UI.get_node("SliderMenu/Lambda2Trees").visible = false
...
func random_iso_point(cell:Vector2) -> Vector2:
	...
	point.x = cell.x + tile_size.x/2/2
	point.y = cell.y + tile_size.y/2
...
func add_tree(cell:Vector2) -> void:
	...
	#new_tree.position = cartesian_to_isometric(cell)#Vector2(cell.x,cell.y)
